...
Every state exists in equilibrium. Equilibrium is the primary rule of the universe. Therefore, the sound that created the universe must have emitted in equal amount to self-balance and nullify. Therefore a positive(energy flowing from left to right) and negative(energy flowing from right to left) emanation happens. Let's call them positive and negative directions(it has no preferential meaning attached to it).

## The positive & negative halves of param tatva(L-->R, L<--R)

<table>
  <tr>
    <td align="center">
      <img src="maheshwara_animated.svg" width="400"/><br/>
      <b>Positive Flow (L→R)</b>
    </td>
    <td align="center">
      <img src="paramtatva_negative_flow_light.svg" width="400"/><br/>
      <b>Negative Flow (R→L)</b>
    </td>
  </tr>
</table>
